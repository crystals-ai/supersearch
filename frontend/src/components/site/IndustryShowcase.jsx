...
const INDUSTRIES = [
  ...
  },
  {
    ...
    query:
      "I want to design my living room under $500. I'm going for white hues and a vibrant vibe. Design this for me.",
    replyIntro: "White base with bold accents — here's a curated living room:",
    replyBullets: [
      "Modular cream 3-seater · $200",
      "Terracotta lounge chair · $120",
      "Travertine coffee table · $100",
      "Sunset arc floor lamp + curated art wall · $50",
      "Rust-hued floor rug + indoor palm · $20",
    ],
  ...
  },
  {
    ...
    replyBullets: [
      ...
      "Estimated monthly spend: £200 — delivered weekly",
    ],
